...
void draw_random_item()
{
	...
	do {
		...
		item1_y = rand() % 25 + 10;
	} while (xy[item1_x][item1_y] == 1);
	xy[item1_x][item1_y] == 1;
	...
	do {
		...
		item2_y = rand() % 25 + 10;
	} while (xy[item2_x][item2_y] == 1);
	xy[item3_x][item3_y] == 1;
	...
	do {
		...
		item4_y = rand() % 25 + 10;
	} while (xy[item4_x][item4_y] == 1);
	xy[item4_x][item4_y] == 1;
	...
	do {
		...
		item5_y = rand() % 25 + 10;
	} while (xy[item5_x][item5_y] == 1);
	xy[item5_x][item5_y] == 1;
	...
	do {
		...
		item6_y = rand() % 25 + 10;
	} while (xy[item6_x][item6_y] == 1);
	xy[item6_x][item6_y] == 1;
	...
	do {
		...
		item7_y = rand() % 25 + 10;
	} while (xy[item7_x][item7_y] == 1);
	xy[item7_x][item7_y] == 1;
	...
	do {
		...
		item8_y = rand() % 25 + 10;
	} while (xy[item8_x][item8_y] == 1);
	xy[item8_x][item8_y] == 1;
...
// 캐릭터 움직이기
void move_star2(int inven[], int iCnt)
{
...
// 맵2 그리기
void draw_map2(int inven[], int iCnt)
{
	draw_map(2);
	draw_inventory(inven, iCnt);
	show_message(2);
